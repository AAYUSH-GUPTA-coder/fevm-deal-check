...
task("check-deal", "check deal activation from deal ID")
    ...
    .setAction(async (taskArgs) => {
        ...
        console.log("The status of deal is:", fileDataResult.terminated)
        console.log("The status of deal is:", fileDataResult.activated)

        let fileDataResult1 = await check.checkDealStatusData1(dealId, {
            gasLimit: 1000000, //797263
        })
        console.log("The status of deal is:", fileDataResult1)
        console.log("The status of deal is:", fileDataResult1.terminated)
        console.log("The status of deal is:", fileDataResult1.activated)
